    ...
    <div className="space-y-6 p-4 pb-8">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 text-sm">
            <div className="font-semibold text-slate-900">{t("contacts.crashDetection")}</div>
            <p className="mt-1 text-xs text-slate-600">{t("contacts.crashDetectionDesc")}</p>
          </div>
          <button
            ...
            aria-label={t("contacts.toggleCrash")}
          >
            <span
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 text-sm">
            <div className="font-semibold text-slate-900">{t("contacts.vibrations")}</div>
            <p className="mt-1 text-xs text-slate-600">{t("contacts.vibrationsDesc")}</p>
          </div>
          <button
            ...
            aria-label={t("contacts.toggleVibration")}
          >
            <span
              className={`absolute top-0.5 h-5 w-5 rounded-full bg-white transition ${
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          <div className="text-sm font-semibold text-slate-900">{t("contacts.emergencyContacts")}</div>
      ...
      {contacts.length < 3 && (
        <div className="space-y-2 rounded-2xl border border-slate-200 bg-white p-4">
          <div className="text-sm font-semibold text-slate-900">{t("contacts.add")}</div>
          <Input value={name} onChange={(e) => setName(e.target.value)} placeholder={t("contacts.namePlaceholder")} className="h-11" />
          <Input
            value={phone}
